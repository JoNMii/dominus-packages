...
DDPRateLimiter.addRule(battleSubRule, 5, 5000);
...
DDPRateLimiter.addRule(battle_notifications_at_hexSubRule, 5, 5000);
...
DDPRateLimiter.addRule(fightSubRule, 5, 5000);
...
DDPRateLimiter.addRule(lastFightInBattleSubRule, 5, 5000);
...
DDPRateLimiter.addRule(roundtitlesSubRule, 5, 5000);
